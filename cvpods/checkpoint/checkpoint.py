...
class Checkpointer(object):
    ...
    def __init__(
        self,
        model: nn.Module,
        loder_pretrain_backbone: bool = False, # [WFD 2022]
        save_dir: str = "",
        resume: bool = False,
        *,
        ...
        **checkpointables: object, 
        ...
        self.loder_pretrain_backbone = loder_pretrain_backbone
    ...
    def _load_model(self, checkpoint: Any):
        ...
        '''[WFD 2022]'''
        if self.loder_pretrain_backbone:
            self.logger.info("Using pretrained backbone model")
            incompatible = self.model.backbone.load_state_dict(
                checkpoint_state_dict, strict=False
            )               
        else:
            self.logger.info("Using Full checkpointer model")
...
class DefaultCheckpointer(Checkpointer):
    ...
    def __init__(self, model, loder_pretrain_backbone=False, save_dir="", resume=False, *, save_to_disk=None, **checkpointables):
        """
        Args:
            model (nn.Module): model.
            save_dir (str): a directory to save and find checkpoints.
