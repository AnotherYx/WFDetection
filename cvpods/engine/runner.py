...
class DefaultRunner(SimpleRunner):
    ...
    def __init__(self, cfg, build_model):
        ...
        '''[WFD 2022]'''
        if cfg.MODEL.get("LOAD_BACKBONE_WEIGHTS"):
            loder_pretrain_backbone = True
        else:
            loder_pretrain_backbone = False
        ...
        self.checkpointer = DefaultCheckpointer(
            ...
            self.model,
            loder_pretrain_backbone, #'True' means we load model_weights form config.py. [WFD 2022]
            cfg.OUTPUT_DIR,
