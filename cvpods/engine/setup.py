...
def adjust_config(cfg):
    ...
    # assert base_world_size == 8, "IMS_PER_BATCH/DEVICE in config file is used for 8 GPUs" #we use only 1 gpu, [WFD 2022]
...
def default_setup(cfg, args):
    ...
    # logger.info("Rank of current process: {}. World size: {}".format( #ignore [WFD 2022]
    #     rank, comm.get_world_size())) #ignore [WFD 2022]
    # logger.info("Environment info:\n" + collect_env_info())  #ignore [WFD 2022]

    # logger.info("Command line arguments: " + str(args)) #ignore [WFD 2022]
