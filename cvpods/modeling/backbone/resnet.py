...
def build_resnet_backbone(cfg, input_shape):
    ...
    for idx, stage_idx in enumerate(range(2, max_stage_idx + 1)):
        ...
        stage_kargs = {#[WFD 2022]
            "num_blocks": num_blocks_per_stage[idx],
            "first_stride": first_stride, #0:1
        ...
        if depth in [18, 34]:
            ...
            stage_kargs["bottleneck_channels"] = bottleneck_channels #0:64
            stage_kargs["stride_in_1x1"] = stride_in_1x1 #0:True
            stage_kargs["dilation"] = dilation #0:1
            stage_kargs["num_groups"] = num_groups #0:1
